...
int multiplica (int &u, int &v) {
	...
	int a0 = primeros(numDigitos, u); // a0
	int a1 = ultimos(numDigitos, u);  // a1
	int b0 = primeros(numDigitos, v); //b0   
	int b1 = ultimos(numDigitos, v);    //b1
	//Operaciones intermedias
	int p=multiplica(a0, b0);
	int q=multiplica(a1, b1);
	int wMasx = a0 + a1;
	int zMasy = b0 + b1;
...
int main () {
	...
	cout << "\nnum2=" << num2;
	//Les multiplicamos!
	cout << "\nEl resultado del producto es: " << multiplica(num1, num2)<<endl;
	return EXIT_SUCCESS;
}